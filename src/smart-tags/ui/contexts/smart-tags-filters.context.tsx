 ...
 */
const SmartTagsFiltersContext = createContext<
	SmartTagsFiltersContextValue | undefined
>(undefined);

/**
 * Provider component that manages filter state and provides it to children
 */
export const SmartTagsFiltersProvider: React.FC<
	SmartTagsFiltersProviderProps
> = ({
	children,
	smartTagsData,
	onApplyFilters,
...
export const useSmartTagsFilters = (): SmartTagsFiltersContextValue => {
	...
	if (context === undefined) {
		throw new Error(
			"useSmartTagsFilters must be used within a SmartTagsFiltersProvider"
		);
	}
