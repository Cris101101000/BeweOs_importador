...
import type { IDeleteFAQModalProps } from "../../types";

export const DeleteFAQModal: React.FC<IDeleteFAQModalProps> = ({
	isOpen,
	onClose,
	onConfirm,
	faq,
									...
									<div className="flex items-start gap-2">
										...
										<div>
											...
											<P className="text-xs text-warning-700 mt-1">
												Al eliminar esta pregunta, Linda ya no podrá responder
												automáticamente a esta consulta. Los clientes tendrán
												que esperar a que respondas manualmente.
											</P>
										</div>
									</div>
								</div>
